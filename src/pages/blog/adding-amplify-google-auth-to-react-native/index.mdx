...
intro: "The first time I added Amplify to a react-native app I had some struggles to overcome. With this post I hope I can get both you and future me up and running in no-time!"
...
<Image src={require("./android-react-native-default-screen.png")} alt="Android react-native default screen" />
...
<Image alt="Select project" src={require("./select-project.png")} />

Select an existing one or create a new one:

<Image alt="Create new project or select an existing one" src={require("./new-project.png")} />
...
<Image  alt="Head to the OAuth consent screen" src={require("./oauth-consent-link.png")}/>
...
<Image  alt="Head to the credentials screen" src={require("./credentials-link.png")}/>

Create new OAuth credentials:

<Image  alt="Create credentials" src={require("./create-credentials.png")}/>
...
<Image  alt="Edit OAuth client" src={require("./edit-oauth-client.png")}/>
...
<Image  alt="Login screen with login button" src={require("./amplify-login-button-screen.png")}/>
...
<Image  alt="Logged in screen" src={require("./logged-in-screen.png")}/>
