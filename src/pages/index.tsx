            ...
            <Box py={3} px={3}>
                ...
                <Masonry>
                    <Box width="300px" mx={3}>
                        <PostCard title="From zero to hero with React and TypeScript: Let's build another to-do app!"
                                  ...
                                  image="https://firebase.google.com/images/social.png" bg="#039BE5"/>
                    </Box>
                    <Box width="300px" mx={3}>
                        <PostCard
